...
public final class Main extends JavaPlugin {
    ...
    public static String getVersion() {
        return "" + ChatColor.WHITE + ChatColor.BOLD + "1.1";
    }

    public static String getPermissionError() { return "" + ChatColor.WHITE + ChatColor.BOLD + "You don't have permissions for this command!"; }
